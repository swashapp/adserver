...
var prepareFullScreenLink = function (url) {
    if(needToAddStyle) {
        ...
        style.innerHTML = `
          ...
          .swash-fullscreen-link:active {
            box-shadow: inset 0 0 10px #0003 !important;
          }
        `;
        document.querySelector('head').appendChild(style);
        needToAddStyle = false;
    }
    ...
    link.setAttribute('style', 'width: 43px; height: 44px;');

    link.innerHTML = '<svg width="42" height="43" viewBox="0 0 42 43" fill="none" xmlns="http://www.w3.org/2000/svg">' +
        '<path d="M33.1061 23.8123V33.0116C33.1035 34.6294 32.4717 36.1802 31.3493 37.3241C30.2269 38.4681 28.7053 39.1119 27.118 39.1145H9.80049C8.21314 39.1119 6.69155 38.4681 5.56913 37.3241C4.4467 36.1802 3.81498 34.6294 3.81239 33.0116V15.3622C3.81498 13.7444 4.4467 12.1936 5.56913 11.0497C6.69155 9.90573 8.21314 9.2619 9.80049 9.25926H18.4641V5.37378H9.80049C7.20124 5.37378 4.70845 6.42612 2.8705 8.29931C1.03255 10.1725 0 12.7131 0 15.3622L0 33.0116C0 35.6607 1.03255 38.2013 2.8705 40.0745C4.70845 41.9477 7.20124 43 9.80049 43H27.118C29.7172 43 32.21 41.9477 34.0479 40.0745C35.8859 38.2013 36.9184 35.6607 36.9184 33.0116V23.8123H33.1061Z" fill="white"/>' +
        '<path d="M41.897 1.73798C41.8945 1.27612 41.7126 0.834082 41.3913 0.508431C41.0699 0.182781 40.6351 -7.54047e-06 40.182 2.33302e-10L24.756 0.109872C24.5205 0.0916921 24.2839 0.123266 24.061 0.202617C23.838 0.281968 23.6336 0.407385 23.4604 0.571013C23.2872 0.73464 23.1491 0.932951 23.0546 1.15352C22.9601 1.37409 22.9113 1.61217 22.9113 1.85285C22.9113 2.09352 22.9601 2.3316 23.0546 2.55217C23.1491 2.77274 23.2872 2.97105 23.4604 3.13468C23.6336 3.29831 23.838 3.42372 24.061 3.50307C24.2839 3.58242 24.5205 3.614 24.756 3.59582L38.4767 3.50592L38.5747 17.4897C38.5568 17.7296 38.5878 17.9708 38.6657 18.198C38.7435 18.4252 38.8666 18.6336 39.0271 18.8101C39.1877 18.9866 39.3823 19.1274 39.5987 19.2237C39.8151 19.32 40.0487 19.3697 40.2849 19.3697C40.521 19.3697 40.7546 19.32 40.971 19.2237C41.1875 19.1274 41.382 18.9866 41.5426 18.8101C41.7031 18.6336 41.8262 18.4252 41.9041 18.198C41.9819 17.9708 42.0129 17.7296 41.9951 17.4897L41.897 1.73798ZM19.6793 25.4105L41.3972 2.99652L38.9667 0.519396L17.239 22.9733L19.6793 25.4105Z" fill="white"/>' +
        '</svg>';
